...
<div>
      ...
      >
        ...
        <button
          class="button-element-top tooltip"
          :style="styleButton"
      ...
      >
        ...
        <button
          class="button-element-bottom tooltip"
          :style="styleButton"
          :runmode="getDisableValue"
          @blur="isClicked = false"
          @mouseover="updateMouseCursor"
...
<script lang="ts">
import { Component, Watch, Emit, Mixins, Ref } from 'vue-property-decorator'
...
export default class FDSpinButton extends Mixins(FdControlVue) {
  @Ref('spinButtonRef') spinButtonRef: HTMLDivElement;
